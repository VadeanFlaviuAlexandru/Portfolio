    ...
    return (
        <section>
            <div className='flex flex-col items-center justify-center'>
                ...
                >
                    Hello, I'm <span className="font-bold"> Alex.</span><br />
                    <span className="font-bold">Full-stack developer</span> with a deep appreciation<br />
                    for <span className="font-bold">art</span> and <span className="font-bold">technology.</span>
                </motion.h1>
                <motion.div
